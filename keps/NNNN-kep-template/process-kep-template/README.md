...
### Scope & Impact
<!--
Briefly describe who is impacted by this change. Please be clear and specific so that the change
can be adequately publicized and circulated before going into effect.

Does this process affect:
  - The entire Kubernetes community
  - A specific SIG's internal process
  - Multiple SIGs
  - End users
  - etc...
-->
...
The KEP should keep this high-level with a focus on what
